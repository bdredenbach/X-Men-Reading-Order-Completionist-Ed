...
## What "Completionist" means here

This project is intended to follow the main Earth-616 X-Men story as completely as practical, rather than being an essentials-only list.

It includes:
- X-Men and Uncanny X-Men
- Major mutant team books and crossover events
...
For the full PWA experience, serve it over HTTPS (GitHub Pages does this automatically).

## Privacy

Reading progress is stored locally in the browser. This project does not require an account or a server-side database.

## Disclaimer

This is an unofficial fan-made project. Marvel, X-Men, and related characters, titles, and trademarks are the property of their respective owners. This repository is not affiliated with or endorsed by Marvel Entertainment.

## License

The original software/code in this repository is released under the MIT License. See `LICENSE`.

The reading-order content and artwork may have separate rights or ownership and are not automatically licensed under the MIT License.
